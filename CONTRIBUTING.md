...
If unique, [open an issue](https://github.com/gopad/homebrew-gopad/issues) and answer the questions so we can understand and reproduce the problematic behavior.
